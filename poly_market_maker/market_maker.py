...
# TODO: proper logging config, in a file
...
class ClobMarketMakerKeeper:
    ...
    def __init__(self, args: list, **kwargs):
        ...
        self.clob_client = self._init_clob_client(self.args)


    def _init_clob_client(self, args):
        ...
        try:
            ...
            if ok == "OK":
                self.logger.info("CLOB API is UP!")
                self.logger.info("Keeper Signer address: {}".format(clob_client.get_address()))
                return clob_client
        except:
            self.logger.error("CLOB API is DOWN, shutting down...")
            return None
