...
class FPMM:
    ...
    def get_price(self, conditional_token: str, fpmm: str, token_id: str, token_complement_id: str) -> float:

        token_balance = self.contracts.balance_of_erc1155(conditional_token, fpmm, token_id)

        complement_balance = self.contracts.balance_of_erc1155(conditional_token, fpmm, token_complement_id)
